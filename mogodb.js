...
const dbname = 'ATNexample';
const uri = 'mongodb+srv://admin:dGcw1Px90hiiLDfo@cluster0.nay39.mongodb.net/ATNexample?retryWrites=true&w=majority';
...
mongoose.connect(uri, { useNewUrlParser: true, useUnifiedTopology: true },
    ...
    res.render("product", {title: "ATN-Shop create PRODUCT page", Notify: "", configHeader: router.params.configHeader , currpage: "create Product" });
}
